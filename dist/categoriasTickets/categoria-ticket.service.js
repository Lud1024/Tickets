...
exports.CategoriaTicketService = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const categoria_ticket_entity_1 = require("./entities/categoria-ticket.entity");
let CategoriaTicketService = class CategoriaTicketService {
    constructor(categoriaTicketRepository) {
    ...
    create(crearCategoriaTicketDto) {
        const categoriaTicket = new categoria_ticket_entity_1.CategoriaTicket();
    ...
    async update(id, actualizarCategoriaTicketDto) {
...
exports.CategoriaTicketService = CategoriaTicketService;
exports.CategoriaTicketService = CategoriaTicketService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(categoria_ticket_entity_1.CategoriaTicket)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], CategoriaTicketService);
//# sourceMappingURL=categoria-ticket.service.js.map